  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Hexo博客', link: 'https://yihan12.github.io/' },
      {
        ...
        items: [
          ...
          {
            text: '掘金',
            link: 'https://juejin.cn/user/3016715638158381/posts',
          },
          {
            text: 'segmentfault',
            link: 'https://segmentfault.com/u/yihan123/articles',
          },
    ...
    sidebar: [
      ...
      },
      {
        ...
        children: [
          { title: '前言', path: 'html&css/' },
          { title: 'object-fit和object-position', path: 'html&css/object-fit' },
        ],
      },
      {
        title: 'ES6+',
